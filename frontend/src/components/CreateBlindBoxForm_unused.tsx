        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <label
                      ...
                      className="flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl hover:from-blue-600 hover:to-cyan-600 cursor-pointer transition-all duration-200 shadow-lg"
                    >
                    ...
                    {formData.image && (
                      <div className="relative">
                        <img src={formData.image} alt="预览" className="w-16 h-16 object-cover rounded-xl shadow-md" />
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <label
                            ...
                            className="flex items-center px-4 py-2 bg-gradient-to-r from-blue-400 to-cyan-400 text-white text-sm rounded-lg hover:from-blue-500 hover:to-cyan-500 cursor-pointer transition-all duration-200"
                          >
                          ...
                          {item.image && (
                            <img src={item.image} alt="预览" className="w-10 h-10 object-cover rounded-lg shadow-md" />
                          )}
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex justify-end space-x-4 pt-8 border-t border-gray-200">
              ...
              <button
                type="submit"
                disabled={submitting || uploading || !isValidProbability}
